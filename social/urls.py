...
urlpatterns = [
    ...
    path('password-change/' , auth_views.PasswordChangeView.as_view(success_url=reverse_lazy('social:password_change_done')) , name='password_change'),
    ...
    path('panel_admin/delete_post/<post_id>' , views.delete_post , name='delete_post'),
    path('posts/create_post/<post_id>' , views.edit_post , name='edit_post'),
